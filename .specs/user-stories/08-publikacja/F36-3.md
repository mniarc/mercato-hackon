...
1. Bezpośrednio przed rozpoczęciem adapter atomowo sprawdza rezerwację, wersję, zgodę i brak blokady oraz przełącza próbę w stan wysyłania.
2. Unieważniona rezerwacja nie jest wykonana, także gdy wcześniej przeszła kontrolę 8.4.
3. Adapter rzeczywiście wysyła niezmienny zaakceptowany tekst do przypisanego celu przez obsługiwaną integrację.
4. Zapis odpowiedzi rozróżnia potwierdzenie z ID wiadomości, pewne odrzucenie i wynik nieznany; brak odpowiedzi nie jest sukcesem.
5. Utrata odpowiedzi nie uruchamia niewidocznego ponowienia; wynik trafia do rozstrzygnięcia 8.6.
