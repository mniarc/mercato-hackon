...
Jako właściciel realizacji chcę uruchomić jeden etap publikacji dla przekazanego postu, żeby powtórzone przekazanie nie tworzyło drugiej publikacji.

### Kryteria akceptacji

1. Zadania publikacji powstają zgodnie ze STD-PROCES i są powiązane z zamówieniem, instrukcją oraz zaakceptowaną wersją postu.
2. W OM widoczne są wykonawcy, zależności i limity użyte dla danego etapu.
3. Ponowne otrzymanie tego samego przekazania 7.7 odnosi się do istniejącej realizacji publikacji i nie tworzy drugiej.
4. Aktywacja prowadzi do sprawdzenia celu i dostępu 8.2; nie oznacza jeszcze gotowości do wysyłki.

### Podstawa ustalenia

Procesy 8–9 są propozycją do przeglądu; własny moduł OM ma realizować reguły publikacji. Zasady produktu: Procesy 8–9; Open Mercato: OM-06. Źródło: arkusz Proces, kroki 8.1.
...
8.1 — Uruchomienie zdefiniowanego etapu publikacji
