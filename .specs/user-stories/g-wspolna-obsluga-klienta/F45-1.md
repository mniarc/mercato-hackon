...
1. O-G.5 zawiera intencję, właściwe wyniki zakresu i wpływu, uzasadnienie oraz dozwolony krok docelowy.
2. Decyzja zostaje zapisana w WEW-ZGLOSZENIE, a dla uruchomionego zamówienia również w WEW-ZMIANY.
3. Routing obsługuje odpowiedź, doprecyzowanie, odmowę rozszerzenia, zmianę, akceptację, wstrzymanie i przekazanie wyjątku do E.1 zgodnie z wynikiem.
4. Lokalny koordynator używa zapisanej kwalifikacji; nie uruchamia G drugi raz dla tego samego rozstrzygnięcia.
5. Klient otrzymuje odpowiedź lub informację o następnym kroku bez potrzeby ręcznego wybierania agentów.
