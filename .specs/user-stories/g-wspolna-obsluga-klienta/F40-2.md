...
Jako osoba zainteresowana pakietem chcę zadać pytanie przed zakupem, żeby dostać odpowiedź bez zakładania zamówienia.

### Kryteria akceptacji

1. Przed zakupem wymagane powiązanie obejmuje kontakt i produkt; zamówienie pozostaje opcjonalne.
2. Pytanie przechodzi jeden triaż i otrzymuje dyspozycję do sprzedaży w 1.2.
3. Oryginał i decyzja pozostają w WEW-ZGLOSZENIE bez tworzenia WEW-ZMIANY nieuruchomionego zamówienia.
4. Pytanie o pakiet nie uruchamia bezpłatnego audytu ani realizacji usługi.

### Podstawa ustalenia

Proces, G.1/G.5 (wiersze 61/65): przed zakupem kontakt i produkt; 1.2: odpowiedź z katalogu bez darmowego audytu. Decyzje, DEC-ZAKUP i DEC-TRIAZ.
...
1.1 — Zapoznanie z ofertą i wybór pakietu (F01-1, F60-1)
...
Zadaje pytanie i ewentualnie doprecyzowuje produkt.
