...
Jako klient chcę wiedzieć, które materiały trzeba zaktualizować po zmianie kierunku, żeby akceptować właściwe rezultaty i zachować niezmienione ustalenia.

### Kryteria akceptacji

1. Plan wpływu wymienia dotknięte pola, dokumenty i wersje, blokady, niezmienione części oraz najwcześniejszy krok wznowienia.
2. Zmiana odbiorcy może skierować pracę do briefu i oznaczyć zależne strategię, TOV, plan i post jako wymagające przeglądu.
3. Nieaktualne zależności nie mogą uruchomić dalszego wykonania ani publikacji.
4. Poprzednie wersje i ich akceptacje pozostają w historii; nie stają się zgodami na nowe wersje.
5. Koordynator realizuje wskazany powrót bez automatycznego uruchamiania całego zamówienia od nowa.

### Podstawa ustalenia

Proces, G.4 (wiersz 64): dotknięte wersje, blokady, najwcześniejszy krok, części niezmienione i historia akceptacji. Decyzje, DEC-WPLYW / DEC-KIERUNEK: brief, strategia, TOV, plan i post.
...
Przekazuje zmianę i później akceptuje aktualizowane materiały.

### Interwencja pracownika

Interweniuje jedynie przy nierozstrzygalnym konflikcie.
