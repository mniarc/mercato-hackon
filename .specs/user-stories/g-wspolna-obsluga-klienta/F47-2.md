...
1. Zgłoszenie dotyczące wysłanej treści jest powiązane z faktyczną wersją, celem i dowodem publikacji; przy wyniku nieznanym najpierw ustalany jest stan.
2. Przygotowanie poprawionej treści nie tworzy automatycznie drugiej publikacji ani nowego zakupionego rezultatu.
3. System nie zakłada możliwości usunięcia lub edycji zewnętrznej wiadomości, jeśli używany adapter nie obsługuje takiej operacji.
4. Jeśli brak ustalonej i wykonalnej ścieżki naprawy, sprawa zachowuje opis przeszkody i trafia do rozstrzygnięcia E, bez oznaczania naprawy jako wykonanej.
