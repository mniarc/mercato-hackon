...
1. Ponowne odebranie tego samego zdarzenia jest rozpoznawane jako duplikat.
2. Duplikat zachowuje istniejący dowód i status prawidłowo opłaconego zamówienia.
3. Dla tego samego opłacenia nie powstaje drugie zamówienie, drugie zlecenie realizacji ani drugi pusty rejestr zmian.
4. W sprawie OM pozostaje jedno powiązanie opłaconego zamówienia z instancją STD-PROCES.
