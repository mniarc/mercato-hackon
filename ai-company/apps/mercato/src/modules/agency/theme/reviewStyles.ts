...
.ag-review .ag-tasks-h h2{font-size:15px;font-weight:var(--agency-heading-weight,500);margin:0}
...
.ag-review .ag-task.sel{border-color:transparent;color:#fff;background:radial-gradient(150% 180% at 100% 0%,var(--agency-gradient-start,#9b8bff) 0%,var(--agency-accent,#7256ec) 52%,var(--agency-gradient-end,#5a3fd0) 100%);box-shadow:0 20px 46px -28px rgba(var(--agency-shadow-rgb,90,63,208),.7)}
.ag-review .ag-task-n{width:28px;height:28px;border-radius:8px;display:grid;place-items:center;font-size:12px;font-weight:var(--agency-heading-weight,500);background:color-mix(in srgb,var(--foreground) 8%,transparent);color:var(--muted-foreground);flex:none}
.ag-review .ag-task.sel .ag-task-n{background:rgba(255,255,255,.22);color:#fff}
.ag-review .ag-task-tx{min-width:0;flex:1}
.ag-review .ag-task-tx b{font-size:13.5px;font-weight:var(--agency-heading-weight,500);display:block;line-height:1.3}
.ag-review .ag-task-pill{font-size:9.5px;font-weight:var(--agency-heading-weight,500);padding:3px 8px;border-radius:999px;white-space:nowrap;background:color-mix(in srgb,var(--foreground) 8%,transparent);color:var(--muted-foreground);flex:none}
