...
export const nativeClientSubmissionDefinition: WorkflowDefinitionData = {
  steps: [
    ...
    { stepId: 'post_review', stepName: 'Post content review handoff recorded', stepType: 'AUTOMATED' },
    { stepId: 'post_review_invited', stepName: 'Post content review available', stepType: 'END' },
    { stepId: 'post_review_waiting', stepName: 'Post review continuation needs attention', stepType: 'WAIT_FOR_SIGNAL',
      signalConfig: { signalName: 'agency.post-production.follow-up' } },
  ...
  transitions: [
    ...
    { transitionId: 'post_review_invitation_available', fromStepId: 'post_review', toStepId: 'post_review_invited', trigger: 'auto',
      condition: { field: 'agencyPostInvitation.result.status', operator: '=', value: 'invited' } },
    { transitionId: 'hold_post_review_continuation', fromStepId: 'post_review', toStepId: 'post_review_waiting', trigger: 'auto',
      condition: { field: 'agencyPostInvitation.result.status', operator: '=', value: 'blocked' } },
