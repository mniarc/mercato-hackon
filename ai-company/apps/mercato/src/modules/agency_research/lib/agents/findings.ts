...
export const findingsAgents: AiAgentDefinition[] = [
  ...
  defineAgent({
    ...
    instructions: [
      ...
      'post. If `repair_findings` is non-empty, fix exactly those paths first.',
      SHARED_RULES,
  ...
  defineAgent({
    ...
    instructions: [
      ...
      'the client for a revision. Do not repeat `validator_findings` — they are already recorded;',
