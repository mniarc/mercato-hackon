...
export const aiAgents: AiAgentDefinition[] = [...sourcesAgents, ...peopleAgents, ...auditAgents, ...competitorsAgents, ...findingsAgents, ...briefAgents, ...strategyAgents, ...planAgents, ...postAgents]
