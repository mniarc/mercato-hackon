# RES-06 - One golden native run, journaled, and the demo evidence around it

State: queued (after RES-04, RES-05 and the unblocked T30/T31/T32; owner: whoever runs the demo rehearsal, Marcin pays)
Depends on: T93, T95, T96 (harness), `yarn mercato agency_research journal` (research lane), RES-04 decisions
