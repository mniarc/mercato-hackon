...
System weryfikuje aktualność planu, jego QA i zaakceptowanych podstaw przed zapisaniem decyzji.

## Evidence

- `ai-company/apps/mercato/src/modules/agency_research/lib/planAcceptance/read.ts` — Current plan, exact QA and current accepted foundations are rechecked.
